    ...
    private void initData() {
        ...
        app.addChild(
                new TreeNode<>(new Dir("manifests"))
                        ...
                        .addChild(new TreeNode<>(new Dir("recyclertreeview"))
                                .addChild(new TreeNode<>(new Dir("Dir")))
                                .addChild(new TreeNode<>(new Dir("DirectoryNodeBinder")))
                                .addChild(new TreeNode<>(new Dir("File")))
                                .addChild(new TreeNode<>(new Dir("FileNodeBinder")))
                                .addChild(new TreeNode<>(new Dir("TreeViewBinder"))))
                        .addChild(new TreeNode<>(new Dir("recyclertreeview2"))
                                .addChild(new TreeNode<>(new Dir("Dir")))
                                .addChild(new TreeNode<>(new Dir("DirectoryNodeBinder")))
                                .addChild(new TreeNode<>(new Dir("File")))
                                .addChild(new TreeNode<>(new Dir("FileNodeBinder")))
...
//                        .lock() // lock this TreeNode
                        .addChild(new TreeNode<>(new Dir("activity_main.xml")))
                        .addChild(new TreeNode<>(new Dir("item_dir.xml")))
                        .addChild(new TreeNode<>(new Dir("item_file.xml")))
        );
        res.addChild(
